...
public class ContrailConfig 
{
	...
	public static void printConfiguration()
	{
		...
		System.out.println("Contrail x.x \n");
		System.out.println("==================================================================================\n");
		System.out.println("Input: "         + hadoopReadPath + "\n");
		System.out.println("Workdir: "       + hadoopBasePath  + "\n");
		System.out.println("localBasePath: " + localBasePath + "\n");
		
		System.out.println("HADOOP_MAPPERS = "    + HADOOP_MAPPERS + "\n");
		System.out.println("HADOOP_REDUCERS = "   + HADOOP_REDUCERS + "\n");
		System.out.println("HADOOP_JAVA_OPTS = "  + HADOOP_JAVAOPTS + "\n");
		System.out.println("HADOOP_TIMEOUT = "    + HADOOP_TIMEOUT + "\n");
		System.out.println("HADOOP_LOCALNODES = " + HADOOP_LOCALNODES + "\n");
		
		if (STARTSTAGE != null)  { System.out.println("STARTSTAGE = " + STARTSTAGE + "\n"); }
			
		System.out.println("RESTART_INITIAL = " + RESTART_INITIAL + "\n");
			
		System.out.println("RESTART_TIP = " + RESTART_TIP + "\n");
		System.out.println("RESTART_TIP_REMAIN = " + RESTART_TIP_REMAIN + "\n");
		
		System.out.println("RESTART_COMPRESS = " + RESTART_COMPRESS + "\n");
		System.out.println("RESTART_COMPRESS_REMAIN = " + RESTART_COMPRESS_REMAIN + "\n");
		
		System.out.println("RESTART_SCAFF_PHASE = " + RESTART_SCAFF_PHASE + "\n");
		System.out.println("RESTART_SCAFF_STAGE = " + RESTART_SCAFF_STAGE + "\n");
		System.out.println("RESTART_SCAFF_FRONTIER = " + RESTART_SCAFF_FRONTIER + "\n");

		if (STOPSTAGE  != null) { System.out.println("STOPSTAGE = "  + STOPSTAGE + "\n");  }
		
		System.out.println("K = "               + K + "\n");
		System.out.println("MAXR5 = "           + MAXR5 + "\n");
		System.out.println("MAXTHREADREADS = "  + MAXTHREADREADS + "\n");
		System.out.println("TRIM5 = "           + TRIM5 + "\n");
		System.out.println("TRIM3 = "           + TRIM3 + "\n");
		System.out.println("RECORD_ALL_THREADS = " + RECORD_ALL_THREADS + "\n");

		System.out.println("TIPLENGTH = "       + TIPLENGTH + "\n");

		System.out.println("MAXBUBBLELEN = "    + MAXBUBBLELEN + "\n");
		System.out.println("BUBBLEEDITRATE = "  + BUBBLEEDITRATE + "\n");
		
		System.out.println("LOW_COV_THRESH = "  + LOW_COV_THRESH + "\n");
		System.out.println("MAX_LOW_COV_LEN = " + MAX_LOW_COV_LEN + "\n");
		
		System.out.println("MIN_THREAD_WEIGHT = " + MIN_THREAD_WEIGHT + "\n");
		
		System.out.println("INSERT_LEN = "     + INSERT_LEN + "\n");
		System.out.println("MIN_WIGGLE = "     + MIN_WIGGLE + "\n");
		System.out.println("MIN_CTG_LEN = "    + MIN_CTG_LEN + "\n");
		System.out.println("MIN_UNIQUE_COV = " + MIN_UNIQUE_COV + "\n");
		System.out.println("MAX_UNIQUE_COV = " + MAX_UNIQUE_COV + "\n");
		System.out.println("MAX_FRONTIER = "   + MAX_FRONTIER + "\n");
		
		System.out.println("RUN_STATS = " + RUN_STATS + "\n");
		System.out.println("N50_TARGET = " + N50_TARGET + "\n");
		
		System.out.println("CONVERT_FA = " + CONVERT_FA + "\n");
	...
	public static void parseOptions(String [] args)
	{
	    ...
	    try 
	    {
	        ...
	        {
	        	System.out.print("Contrail version x.x (Schatz et al. http://contrail-bio.sf.net)\n" +
	        			         "\n" +
